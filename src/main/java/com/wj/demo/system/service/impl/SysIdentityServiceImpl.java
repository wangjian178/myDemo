package com.wj.demo.system.service.impl;
...
import com.wj.demo.system.mapper.SysIdentityMapper;
...
public class SysIdentityServiceImpl extends ServiceImpl<SysIdentityMapper, SysIdentity> implements SysIdentityService {
    ...
    public SysIdentity getSysIdentityByCode(String code) {
        LambdaQueryWrapper<SysIdentity> queryWrapper = Wrappers
                .lambdaQuery(SysIdentity.class)
    ...
    public boolean existWithCode(String code) {
        Wrapper<SysIdentity> queryWrapper = Wrappers.<SysIdentity>lambdaQuery()
                .eq(SysIdentity::getDeleted, Boolean.FALSE)
                .eq(SysIdentity::getCode, code);
