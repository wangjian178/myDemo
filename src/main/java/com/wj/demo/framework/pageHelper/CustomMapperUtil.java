        ...
        try {
            ...
            if (page.getTotalRow() < 0) {
                ...
                if (page.needOptimizeCountQuery()) {
                    countQueryWrapper = CustomMapperUtil.optimizeCountQueryWrapper(queryWrapper);
                } else {
                    countQueryWrapper = CustomMapperUtil.rawCountQueryWrapper(queryWrapper);
                }
